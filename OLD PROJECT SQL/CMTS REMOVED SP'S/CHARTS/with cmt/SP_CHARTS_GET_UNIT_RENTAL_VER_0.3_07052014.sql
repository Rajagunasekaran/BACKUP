-- VER 0.3 TRACKER NO:817 COMMENT #35 STARTDATE:07/05/2014 ENDDATE:07/05/2014 DESC: CHANGED TEMP TABLE FOR DYNAMIC PURPOSE DONE BY:RAJA
-- VER 0.1 TRACKER NO:595 COMMENT #51 STARTDATE:27/01/2014 ENDDATE:27/01/2014 DESC: This procedure is called in SP_CHARTS_PERSONAL_NET_REVENUE SP. DONE BY:MANIKANDAN.S
-- VER 0.2 TRACKER NO:595 COMMENT # STARTDATE:29/01/2014 ENDDATE:29/01/2014 DESC:INCLUDED CONDITION FOR GETTING ACTIVE UNIT ONLY. DATE CONDITION WAS NOT CORRECT IN THE QUERY FOR GETTING UNIT RENTAL, FIXED THAT ISSUE. SP. DONE BY:MANIKANDAN.S
...
END;
  ...
  -- DROP TABLE IF EXISTS TEMP_UNIT_RENTAL;
  ...
  -- DROP TABLE IF EXISTS TEMP_UNIT_DETAILS;
...
SELECT @TEMP_UNIT_RENTAL;
select * from TEMP_UNIT_RENTAL20140510180419_1;
*/