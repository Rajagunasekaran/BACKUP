...
END;
/*
CALL SP_DUPLICATE_CARD_CUSTOMERS('test_cards',@TEMP_LP_DUPLICATE_CARDS,@TEMP_ACCESS_DUPLICATE_CARDS);
SELECT @TEMP_LP_DUPLICATE_CARDS,@TEMP_ACCESS_DUPLICATE_CARDS;
SELECT * FROM TEMP_LP_DUPLICATE_CARDS_20140808094222;
SELECT * FROM TEMP_ACCESS_DUPLICATE_CARDS_20140808094222;
*/