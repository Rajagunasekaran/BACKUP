...
DROP PROCEDURE IF EXISTS SP_TS_MIG_REPORT_DETAILS_AFTN_ABSENT_INSERT;
CREATE PROCEDURE SP_TS_MIG_REPORT_DETAILS_AFTN_ABSENT_INSERT(
...
END;
/*
CALL SP_TS_MIG_REPORT_DETAILS_AFTN_ABSENT_INSERT('TS_DEST');
*/