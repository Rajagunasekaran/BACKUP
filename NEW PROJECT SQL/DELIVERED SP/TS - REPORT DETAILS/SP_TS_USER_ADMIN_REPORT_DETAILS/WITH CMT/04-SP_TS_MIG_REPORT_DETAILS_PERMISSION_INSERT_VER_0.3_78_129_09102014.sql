...
BEGIN
	...
	AND UREPORT NOT LIKE "%Permission 3 pm - 7 p%" AND UREPORT NOT LIKE "%PERMISSION FOR FLEX%" AND UREPORT NOT LIKE "%PERMISSION LIST%" AND UREPORT NOT LIKE "%onduty and permission%")'));
