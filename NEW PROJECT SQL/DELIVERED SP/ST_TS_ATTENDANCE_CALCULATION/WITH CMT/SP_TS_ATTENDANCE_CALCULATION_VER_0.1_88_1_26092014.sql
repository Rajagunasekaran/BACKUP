...
BEGIN
	...
	IF(LOGIN_ID IS NOT NULL)THEN    
		...
		SET TOTAL_DAYS=(TOTAL_DAYS-(SELECT COUNT(*) FROM PUBLIC_HOLIDAY WHERE PH_DATE BETWEEN @S AND @E));
...
END;
/*
CALL SP_TS_ATTENDANCE_CALCULATION('JUNE-2014','dhivya.arjunan@ssomens.com','dhandapani.sattanathan@ssomens.com',@TABLE);
*/