...
BEGIN
	...
	COMMIT;
END;
CALL SP_TS_DAILY_REPORT_SEARCH_UPDATE(UARDID,REPORT,REASON,FINALDATE,URCID,LOGIN_ID,URE_PERMISSION,URE_ATTENDANCE,URE_PDID,URE_MORNING_SESSION,URE_AFTERNOON_SESSION,BANDWIDTH,URE_ULD_ID,REPORT_UPDATE);