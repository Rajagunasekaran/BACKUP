...
BEGIN
	...
	AND UREPORT NOT LIKE "%an permission%" AND UREPORT NOT LIKE "%& permission%" AND UREPORT NOT LIKE "%Permission: 2.30pm%")'));
	...
	(1.5,"%1 1/2 h%"), (1.5, "%Permission% 1.30%"),(0.5, "%1/2 hour%"),(2.5, "%2 ND%"),(1, "%1hr%"),(1, "%1 hr%"),(1, "%1 hour%"),(1, "%1hour%"),
	...
	(3,"%3.45 PM  TO 7 P%"),(3,"%3.00pm to 6.0%"),(3,"%4 o%clock on%"),(3,"%till 3.30 pm %"),(3,"%(16:00 - 19:00)%"),(3,"% timing 9.50 - 1.10 %")'));
	...
	WHILE(KEY_MIN_ID <= KEY_MAX_ID)DO      
		...
		WHILE(PER_MIN_ID <= PER_MAX_ID)DO         
			...
			IF (PER_UREPORT IS NOT NULL) THEN
				IF (LOCATION>0) THEN 
				SET STR_LOCATION=(SELECT LOCATE('Reason',PER_UREPORT));
...
END;
/*
CALL SP_TS_MIG_REPORT_DETAILS_PERMISSION_INSERT('DEST_RAJA');
*/