...
BEGIN
	...
	END WHILE;
	IF (PARTNO=1 OR PARTNO=2 OR PARTNO=3)THEN
	...
	IF (PARTNO=4) THEN
		...
		SET @INSERT_USERADMINREPORTDETAILS=(SELECT CONCAT('INSERT INTO ',DESTINATIONSCHEMA,'.USER_ADMIN_REPORT_DETAILS (UARD_REPORT,UARD_REASON,UARD_DATE,URC_ID,ULD_ID,UARD_PERMISSION,UARD_ATTENDANCE,UARD_PDID,UARD_AM_SESSION,UARD_PM_SESSION,UARD_BANDWIDTH,UARD_USERSTAMP_ID,UARD_TIMESTAMP)
...
END;
/*
CALL SP_TS_MIG_REPORT_DETAILS_REPORT_INSERT('SOURCE_RAJA','DEST_RAJA',1,1,1746,'dhandapani.sattanathan@ssomens.com');
CALL SP_TS_MIG_REPORT_DETAILS_REPORT_INSERT('SOURCE_RAJA','DEST_RAJA',2,1747,3492,'dhandapani.sattanathan@ssomens.com');
CALL SP_TS_MIG_REPORT_DETAILS_REPORT_INSERT('SOURCE_RAJA','DEST_RAJA',3,3493,5238,'dhandapani.sattanathan@ssomens.com');
CALL SP_TS_MIG_REPORT_DETAILS_REPORT_INSERT('SOURCE_RAJA','DEST_RAJA',4,5239,6984,'dhandapani.sattanathan@ssomens.com');
*/