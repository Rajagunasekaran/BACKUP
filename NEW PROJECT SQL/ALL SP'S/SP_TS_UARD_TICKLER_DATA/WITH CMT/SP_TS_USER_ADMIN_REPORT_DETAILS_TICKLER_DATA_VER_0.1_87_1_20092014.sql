-- VERSION 0.1 STARTDATE:19/09/2014 ENDDATE:20/09/2014 ISSUE NO:87 COMMENT NO:1 DESC:SP FOR SHOWING TICKLER HISTORY ID INTO DATA. DONE BY :RAJA
DROP PROCEDURE IF EXISTS SP_TS_USER_ADMIN_REPORT_DETAILS_TICKLER_DATA;
CREATE PROCEDURE SP_TS_USER_ADMIN_REPORT_DETAILS_TICKLER_DATA(IN USERSTAMP VARCHAR(50),OUT TEMP_UARD_TICKLER_HISTORY TEXT)
BEGIN
	...
	(TH_ID,TP_ID,ULD_ID,TTIP_ID,TH_OLD_VALUE,TH_NEW_VALUE,TH_USERSTAMP_ID,TH_TIMESTAMP)(SELECT * FROM TICKLER_HISTORY)'));
