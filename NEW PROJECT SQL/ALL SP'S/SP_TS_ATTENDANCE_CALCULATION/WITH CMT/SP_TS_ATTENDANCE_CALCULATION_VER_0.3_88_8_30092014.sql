...
END;
/*
CALL SP_TS_ATTENDANCE_CALCULATION('OCTOBER-2014','raja.gunasekaran@ssomens.com','dhandapani.sattanathan@ssomens.com',@TEMP_ATTENDANCE_CALCULATION,@TOTAL_DAYS,@TOTAL_WORKINGDAYS);
