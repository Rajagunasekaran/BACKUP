-- VERSION 0.5 STARTDATE:28/10/2014 ENDDATE:28/10/2014 ISSUE NO:75 COMMENT NO:7O DESC:ADDED KEYWORD. DONE BY :RAJA
-- VERSION 0.4 STARTDATE:23/10/2014 ENDDATE:23/10/2014 ISSUE NO:75 COMMENT NO:53 DESC:ADDED NEW KEY WORDS FOR THE NEW MIG REPORT. DONE BY :RAJA
...
-- VERSION 0.1 STARTDATE:27/08/2014 ENDDATE:28/08/2014 ISSUE NO:78 COMMENT NO:33 DESC:SP FOR INSERT THE PERMISSION REPORTS. DONE BY :RAJA
...
BEGIN
	...
	-- TEMP TABLE FOR THE LIKE KEY WORDS
	...
	(1.5,"%1 1/2 h%"),(1.5, "%Permission% 1.30%"),(1.5, "%1.5 HR%"),(0.5, "%1/2 hour%"),(2.5, "%2 ND HALF%"),(1, "%1hr%"),(1, "%1 hr%"),(1, "%1 hour%"),(1, "%1hour%"),
	(2, "%2 hr%"),(2, "%2hr%"),(2, "%2 hour%"),(3, "%3 hour%"),(3, "%3 hr%"),(1, "%ONE HOUR%"),(1, "%ONE HR%"),(2, "%TWO%HOUR%"),(3, "%THREE%HOUR%"),(2.5, "%2.5 hr%"),
	(0.5, "%30 min%"),(3, "%came at 12%"),(2.5, "%came%11:30%"),(2, "%came%11.15%"),(2.5,"%2%30 hrs permission%"),(0.5,"%5:30 TO 6:00%"),(0.5,"%18:20(FELT %"),
	(0.5,"%45 min%"),(1,"%at 4.30 to 5.30%"),(1,"%permission:5-6%"),(1,"% 6:15 pm to 7 p%"),(1.5,"%10.30 came back at 12.10pm%"),(1.5,"%:2.00 to 3.30%"),(1.5, "%1.5HR%"),
	(1.5,"%(17:00 - 18:20)%"),(1.5,"%office at 10.30%"),(1.5,"%5.3%-%7%"),(2,"%5 pm - 7 pm%"),(2,"%from 5 clk.%"),(2,"%from 5.15 pm."),(2,"%4.45 pm to 7 pm%"),(2.5, "%2.5hr%"),
	(2,"%from 5pm to 7pm%"),(2.5,"%3:10 PM TO 5:45%"),(2.5,"%cme at 11.30am%"),(2.5,"% at 3.30 till 6:00 pm%"),(2.5,"%( 3.30 to 6.00)%"),(2.5,"% - From  3.45P%"),(3,"%permission - 4 pm - 7 pm%"),
	...
	(3,"%3.45 PM  TO 7 P%"),(3,"%3.00pm to 6.0%"),(3,"%4 o%clock on%"),(3,"%till 3.30 pm %"),(3,"%(16:00 - 19:00)%"),(3,"% timing 9.50 - 1.10 %"),(2.5,"%LEFT OFFICE AT 4.15 P.M%")'));
...
END;
/*
CALL SP_TS_MIG_REPORT_DETAILS_PERMISSION_INSERT('TS_DEST');
*/