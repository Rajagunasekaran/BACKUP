...
if(isset($_POST["choice"])=="SINGLE DAY ENTRY")
{
    ...
    $reportlocation=$_POST['checkoutlocation'];
    $upload_dir = $dir.'generated_pdf'.DIRECTORY_SEPARATOR;
    $data=str_replace('data:image/jpeg;base64,','',$imagedata);
    $data = str_replace(' ','+',$data);
    $data = base64_decode($data);
    $file = $upload_dir."image_name5.jpeg";
    $success = file_put_contents($file, $data);
//    $inputPath=$file;
//    $outputPath=$dir.'generated_pdf\image_name4';
//    $mpdf=new mPDF();
