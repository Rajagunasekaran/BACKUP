<!--//*******************************************FILE DESCRIPTION*********************************************//
//*********************************DAILY REPORTS PROJECT PERMITS UPDATE***********************************//
//VER 0.01-INITIAL VERSION, SD:18/02/2015 ED:01/10/2014,TRACKER NO:1
//*********************************************************************************************************//-->
<?php
include "HEADER.php";
?>
...
$(document).ready(function(){
    ...
    $("#ASRC_UPD_DEL_tble_attachment").hide();
    ...
    $(document).on("change",'.fileextensionchk', function (){
        for(var i=0;i<25;i++)
        {
            ...
            {
                $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:err_msg[15],position:{top:150,left:500}}});
...
//                        }
        ...
        var choice='ALLDATE';
        xmlhttp.open("GET","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?alldate="+date+"&option="+choice,true);
        xmlhttp.send();
        sorting()
    });
...
//                    $('#ASRC_UPD_DEL_tb_band').hide();
            ...
            var choice="login_id"
            xmlhttp.open("GET","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?login_id="+loginid+"&option="+choice,true);
            xmlhttp.send();
...
//                        }
        ...
        xmlhttp.open("POST","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?start_date="+start_date+"&end_date="+end_date+"&option="+choice+"&actionloginid="+activeloginid,true);
        xmlhttp.send();
        sorting()
    }
...
//        $('#ASRC_UPD_DEL_tb_band').hide();
    ...
    $(document).on('click','#ASRC_UPD_DEL_btn_del',function(){
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState==4 && xmlhttp.status==200) {
                ...
                if(delete_msg==1)
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:err_msg[2],position:{top:150,left:500}}});
                    flextablerange()
                    $('#ASRC_UPD_DEL_btn_del').hide();
                    $('#ASRC_UPD_DEL_btn_srch').hide();
                }
                ...
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:err_msg[5],position:{top:150,left:500}}});
                    flextablerange()
                    $('#ASRC_UPD_DEL_btn_del').hide();
                    $('#ASRC_UPD_DEL_btn_srch').hide();
                }
                ...
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:delete_msg,position:{top:150,left:500}}});
                    flextablerange()
                    $('#ASRC_UPD_DEL_btn_del').hide();
                    $('#ASRC_UPD_DEL_btn_srch').hide();
                }
        ...
        var choice="DELETE";
        xmlhttp.open("GET","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?del_id="+delid+"&option="+choice,true);
        xmlhttp.send();
    });
    ...
    function form_show(attendance)
    {
        if(attendance=='1')
        {
            ...
            $("#ASRC_UPD_DEL_tble_attachment").show();
...
//                $('#ASRC_UPD_DEL_tble_bandwidth').html('');
    ...
    $(document).on('change','#ASRC_UPD_DEL_ta_reportdate',function(){
        ...
        if(reportdate!=date){
            ...
            var choice="DATE"
            xmlhttp.open("GET","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?reportdate="+reportdate+"&login_id="+loginid+"&option="+choice,true);
            xmlhttp.send();
        }
        else{
            err_flag=0;
...
//        var ASRC_UPD_DEL_bndtxt = $("#ASRC_UPD_DEL_tb_band").val();
    ...
    $(document).on('click','#ASRC_UPD_DEL_btn_submit',function(){
        ...
        var choice="PROJECT PERMITS UPDATE";
        // Send Request
        request = $.ajax({
            url: "DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php",
            type: "POST",
            data: formElement+"&choice="+choice+"&string="+imgData,
            success: function(response){
                var msg_alert=response;
                $('.preloader', window.parent.document).hide();
                if(msg_alert==1)
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:err_msg[1],position:{top:150,left:500}}});
                    ASRC_UPD_DEL_clear()
                    flextablerange()
                    $("#ASRC_UPD_DEL_btn_del").hide();
                    $("#ASRC_UPD_DEL_btn_srch").hide();
                ...
                if(msg_alert==0)
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:err_msg[7],position:{top:150,left:500}}});
//                    ASRC_UPD_DEL_clear()
//                    flextablerange()
//                    $("#ASRC_UPD_DEL_btn_del").hide();
//                    $("#ASRC_UPD_DEL_btn_srch").hide();
...
//                    $('#ASRC_UPD_DEL_errmsg').hide();
                ...
                {
                    $(document).doValidation({rule:'messagebox',prop:{msgtitle:"PROJECT PERMITS UPDATE",msgcontent:msg_alert,position:{top:150,left:500}}});
//                    ASRC_UPD_DEL_clear()
//                    flextablerange()
//                    $("#ASRC_UPD_DEL_btn_del").hide();
//                    $("#ASRC_UPD_DEL_btn_srch").hide();
...
//                    $('#ASRC_UPD_DEL_errmsg').hide();
    ...
    $(document).on('change','#option',function(){
        ...
        if($('#option').val()=='PROJECT PERMITS UPDATE')
        {
...
// CHANGE EVENT FOR ONDUTY START DATE
    ...
    function ondutyflextable(){
        ...
        var choice='ONDUTY';
        xmlhttp.open("GET","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?sdate="+sdate+"&edate="+edate+"&option="+choice,true);
        xmlhttp.send();
        sorting()
    }
// CLICK EVENT FOR ONDUTY RADIO BUTTON
    ...
    $('#ASRC_UPD_DEL_odsubmit').click(function(){
        ...
        xmlhttp.open("POST","DB_DAILY_REPORTS_PROJECT_PERMITS_UPDATE.php?option="+option,true);
...
<div class="wrapper">
    ...
    <div class="newtitle"><div style="padding-left:500px; text-align:left;"><p><h3>PROJECT PERMITS UPDATE</h3><p></div></div>
    <form   id="ASRC_UPD_DEL_form_adminsearchupdate" class="newcontent" >
            ...
            <tr>
                ...
                <td width="150">
                    <select id="option" name="option">
                        ...
                        <option>PROJECT PERMITS UPDATE</option>
        ...
        <table id="ASRC_UPD_DEL_tble_dailyuserentry" hidden>
            ...
            <table id="ASRC_UPD_DEL_tble_attachment">
                <tr>
                    <td> </td>
                    <td>
