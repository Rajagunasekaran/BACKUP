...
//LOGIN CREWTION SAVE PART
    if($_REQUEST['option']=="loginsave")
    {
        ...
        $folder_name="ATS_REPORT_IMAGE/$subfoldername/";
...
//            $mail->SMTPSecure = 'tls';
//            $mail->From = 'safiyullah84@gmail.com';
//            $mail->FromName = 'safi';
//            $mail->addAddress('safiyullah.mohideen@ssomens.com', 'safiyullah');
//            $mail->WordWrap = 50;
//            $mail->isHTML(true);
