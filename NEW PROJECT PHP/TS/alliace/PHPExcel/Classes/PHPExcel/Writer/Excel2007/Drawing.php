...
*/
	...
	/**
	 * Write VML header/footer ATS_REPORT_IMAGE to XML format
	 *
	 * @param 	PHPExcel_Worksheet				$pWorksheet
	 * @return 	string 								XML Output
	 * @throws 	PHPExcel_Writer_Exception
	...
	public function writeVMLHeaderFooterImages(PHPExcel_Worksheet $pWorksheet = null)
	{
		...
		$objWriter->startDocument('1.0','UTF-8','yes');
  		...
  		// Header/footer ATS_REPORT_IMAGE
	...
	public function allDrawings(PHPExcel $pPHPExcel = null)
	{
		...
		for ($i = 0; $i < $sheetCount; ++$i) {
			// Loop through ATS_REPORT_IMAGE and add to array
