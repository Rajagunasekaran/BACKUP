...
<ul>
<li>CSS background (ATS_REPORT_IMAGE, colours or gradients) on &lt;TR&gt; and &lt;TABLE&gt;</li>
...
<li>expanded support for gradients (including in SVG ATS_REPORT_IMAGE):
<ul>
...
<li>background-image-resolution (custom mPDF CSS-type style) to define resolution of background ATS_REPORT_IMAGE</li>
<li>improved support for SVG ATS_REPORT_IMAGE</li>
<li>SVG and WMF ATS_REPORT_IMAGE supported in background-image</li>
...
<div style="font-family: Arial; font-size: 18pt; color: rgb(49,124,209)">Tables: borders, background ATS_REPORT_IMAGE & gradients</div>

<div class="rounded text">Background ATS_REPORT_IMAGE or gradients can be set on whole tables or table rows (as well as individual table cells)</div>
...
<ul>
<li>mPDF background-gradients are output underneath background-ATS_REPORT_IMAGE, and both can be specified; whereas the new CSS3/Mozilla-type gradients are defined as a type of background-image</li>
...
<li>CSS3 linear gradients - <a href="http://dev.w3.org/csswg/css3-ATS_REPORT_IMAGE/#linear-gradients">http://dev.w3.org/csswg/css3-ATS_REPORT_IMAGE/#linear-gradients</a></li>
<li>CSS3 radial gradients - <a href="http://dev.w3.org/csswg/css3-ATS_REPORT_IMAGE/#radial-gradients">http://dev.w3.org/csswg/css3-ATS_REPORT_IMAGE/#radial-gradients</a></li>
...
<div class="rounded text">Gradients (linear or radial) can also be used to produce \'masks\' for ATS_REPORT_IMAGE. The same syntax is used as for background gradients (e.g. -moz-linear-gradient) but is set using a custom mPDF style: <i>gradient-mask</i>. The rgba() method for defining colours is used: colours are ignored, but the opacity value is used to mask the image.</div>
...
<div class="rounded text">Image files (which do not have an output width or height specified) are displayed in mPDF at the default resolution set by the variable $mpdf->img_dpi. This can be overridden using the draft CSS3 property \'image-resolution\', which can be applied to &lt;IMG&gt; or background-ATS_REPORT_IMAGE.
<br />
