...
<h4>Interlaced and alpha-channel-set PNG ATS_REPORT_IMAGE supported</h4>
<div class="rounded">
Prior to version 3.0, mPDF has not supported PNG ATS_REPORT_IMAGE which are interlaced, or ATS_REPORT_IMAGE with transparency - now it does.
