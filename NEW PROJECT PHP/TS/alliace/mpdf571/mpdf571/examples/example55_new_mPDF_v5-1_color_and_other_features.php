...
<li>Colorspace and colour conversion (almost everything except BMP ATS_REPORT_IMAGE)</li>
<li>Spot colours</li>
<li>PDF/X files</li>
<li>dir="rtl"</li>
...
Backgrounds/gradients/ATS_REPORT_IMAGE now use the bleed box as their "container box", rather than the whole page. (See this document as an example.)
<br />
...
file may contain JPG ATS_REPORT_IMAGE in RGB or CMYK format.
<br />
...
<br />
This will attempt to convert every colour value used in the document to the permitted colorSpace(s). Almost everything including ATS_REPORT_IMAGE
will be converted (except BMP ATS_REPORT_IMAGE), and the conversion of ATS_REPORT_IMAGE may take significant time.
<br />
...
PDF/A and /X files cannot contain ATS_REPORT_IMAGE or colour values with "transparency".
<br />
