...
$(document).ready(function(){
    ...
    $(document).on("click",'#attachprompt', function (){
        ...
        var appendfile='<tr><td ><input type="file" class="fileextensionchk" id='+uploadfileid+' name='+uploadfileid+'></td><td><button type="button" class="removebutton" title="Remove this row" style="background-color:red;color:white;font-size:10;font-weight: bold;">Remove</button><label id="attach_error" hidden></label></td></tr></br>';
...
//BUTTON VALIDATION FOR LOGIN CREATION
    ...
    $(document).on("click",'#URSRC_submitupdate ', function (){
        ...
        xmlhttp.open("POST","DB_ACCESS_RIGHTS_ACCESS_RIGHTS-SEARCH_UPDATE.php?option="+choice+"&filearray="+filenames,true);
        xmlhttp.send(new FormData(formElement));
    });
...
<form  name="URE_attendanceentry" id="URE_attendanceentry" class="content" method="POST">
...
<table id="URSRC_tble_login" hidden>
    ...
    <tr>
        <td width="175"><label id="URSRC_lbl_loginid">USER NAME<em>*</em></label></td>
    ...
    <tr>
        <td width="175" ><label id="URSRC_lbl_loginidupd">USER NAME<em>*</em></label></td>
    ...
    <tr><td width="175"><label name="URSRC_lbl_pword" id="URSRC_lbl_pword" hidden>PASSWORD<em>*</em></label></td>
        <td><input type="password"  name="URSRC_tb_pword" id="URSRC_tb_pword" hidden /></td></tr>
    <tr>

    <tr><td width="175"><label name="URSRC_lbl_cpword" id="URSRC_lbl_cpword" hidden>CONFIRM PASSWORD<em>*</em></label></td>
        <td><input type="password"  name="URSRC_tb_cpword" id="URSRC_tb_cpword" hidden /></td>
    </tr>
    <tr>
