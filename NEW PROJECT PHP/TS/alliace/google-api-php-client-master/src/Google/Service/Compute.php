  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->images = new Google_Service_Compute_Images_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => '{project}/global/ATS_REPORT_IMAGE/{image}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/ATS_REPORT_IMAGE/{image}/deprecate',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/ATS_REPORT_IMAGE',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
 ...
 *  <code>
 *   $computeService = new Google_Service_Compute(...);
 *   $ATS_REPORT_IMAGE = $computeService->ATS_REPORT_IMAGE;
 *  </code>
 */
class Google_Service_Compute_Images_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes the specified image resource. (ATS_REPORT_IMAGE.delete)
   *
   * @param string $project
   * Name of the project scoping this request.
   * @param string $image
   ...
   * the deprecation status instead. (ATS_REPORT_IMAGE.deprecate)
   *
   * @param string $project
   * Name of the project scoping this request.
   * @param string $image
  ...
  /**
   * Returns the specified image resource. (ATS_REPORT_IMAGE.get)
   *
   * @param string $project
   * Name of the project scoping this request.
   * @param string $image
   ...
   * the request. (ATS_REPORT_IMAGE.insert)
   *
   * @param string $project
   * Name of the project scoping this request.
