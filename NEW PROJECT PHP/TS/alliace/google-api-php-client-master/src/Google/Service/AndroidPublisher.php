...
/**
 * The "ATS_REPORT_IMAGE" collection of methods.
 * Typical usage is:
 *  <code>
 *   $androidpublisherService = new Google_Service_AndroidPublisher(...);
 *   $ATS_REPORT_IMAGE = $androidpublisherService->ATS_REPORT_IMAGE;
 *  </code>
 */
class Google_Service_AndroidPublisher_EditsImages_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes the image (specified by id) from the edit. (ATS_REPORT_IMAGE.delete)
   *
   * @param string $packageName
   * Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
   * @param string $editId
   * Unique identifier for this edit.
   * @param string $language
   * The language code (a BCP-47 language tag) of the localized listing whose ATS_REPORT_IMAGE are to read or
    * modified. For example, to select Austrian German, pass "de-AT".
   * @param string $imageType
   *
   * @param string $imageId
   * Unique identifier an image within the set of ATS_REPORT_IMAGE attached to this edit.
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Deletes all ATS_REPORT_IMAGE for the specified language and image type.
   * (ATS_REPORT_IMAGE.deleteall)
   *
   * @param string $packageName
   * Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
   * @param string $editId
  ...
  /**
   * Lists all ATS_REPORT_IMAGE for the specified language and image type.
   * (ATS_REPORT_IMAGE.listEditsImages)
   *
   * @param string $packageName
   * Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
   * @param string $editId
  ...
  /**
   * Uploads a new image and adds it to the list of ATS_REPORT_IMAGE for the specified
   * language and image type. (ATS_REPORT_IMAGE.upload)
   *
   * @param string $packageName
   * Unique identifier for the Android app that is being updated; for example, "com.spiffygame".
   * @param string $editId
