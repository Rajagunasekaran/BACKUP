...
class Google_Service_Customsearch_Cse_Resource extends Google_Service_Resource
{
   ...
   * Returns ATS_REPORT_IMAGE of a type, which can be one of: clipart, face, lineart, news, and photo.
   * @opt_param string gl
   ...
   * Returns ATS_REPORT_IMAGE of a specified type. Some of the allowed values are: bmp, gif, png, jpg, svg,
    * pdf, ...
   * @opt_param string start
   * The index of the first result to return
   * @opt_param string imgDominantColor
   * Returns ATS_REPORT_IMAGE of a specific dominant color: yellow, green, teal, blue, purple, pink, white,
   ...
   * Returns ATS_REPORT_IMAGE of a specified size, where size can be one of: icon, small, medium, large,
    * xlarge, xxlarge, and huge.
   * @opt_param string imgColorType
   * Returns black and white, grayscale, or color ATS_REPORT_IMAGE: mono, gray, and color.
