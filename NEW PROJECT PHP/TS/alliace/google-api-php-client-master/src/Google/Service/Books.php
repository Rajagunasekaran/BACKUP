...
class Google_Service_Books_LayersAnnotationData_Resource extends Google_Service_Resource
{
   ...
   * @opt_param int h
   * The requested pixel height for any ATS_REPORT_IMAGE. If height is provided width must also be provided.
   * @opt_param string locale
   * The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex:
    * 'en_US'.
   * @opt_param int w
   * The requested pixel width for any ATS_REPORT_IMAGE. If width is provided height must also be provided.
