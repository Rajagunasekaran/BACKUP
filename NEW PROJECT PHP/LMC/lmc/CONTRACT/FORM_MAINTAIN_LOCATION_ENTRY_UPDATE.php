                ...
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    if (resultarray.length>0) {
                        ...
                        for (var i = 0; i < resultarray.length; i++) {
                            ...
                            ML_UPD_table_header += '<tr id=' + rowid + ' ><td style="text-align:center;"><div class="col-lg-1"><span style="display: block;color:green" class="glyphicon glyphicon-edit  MLedit" id="MLedit_' + rowid + '"></span></div></td><td nowrap style="text-align:center;">' + refno + '</td><td style="text-align:center;">' + location + '</td><td style="text-align:center;"> ' + recipient + '</td><td  style="text-align:center;">' + contract + '</td><td nowrap>' + dateentered + '</td><td nowrap>' + datecompleted + '</td><td nowrap>' + draftbillcreated + '</td><td>' + jobstatus + '</td><td nowrap style="text-align:center;">' + draftbillstatus + '</td><td style="text-align:center;">' + remark + '</td><td style="text-align:center;">' + username + '</td><td style="text-align:center;" nowrap>' + timestamp + '</td></tr>';
                        }
                ...
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    if (buttonvalue == 'SAVE') {
                        if(result==1)
                        {
                            ...
                            $('#ML_btn_additem').show();
                            $('#ML_btn').hide();
                            $("#maintainlocation").find('input:text, input:password, input:file,textarea').val('');
                            $("#maintainlocation").find('select').val('SELECT');
                            $("#maintainlocation").find('input:radio, input:checkbox').removeAttr('checked').removeAttr('selected');
                        }
                        else
                        {
