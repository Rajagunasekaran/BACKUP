...
<!--    <link rel="stylesheet" href="--><?//= base_url();?><!--Data_table/media/css/fixedHeader.css">-->
<!--    <script type="text/javascript" src="--><?//= base_url();?><!--Data_table/media/js/jquery.dataTables.columnFilter.js"></script>-->
<!--    <script type="text/javascript" src="--><?//= base_url();?><!--Data_table/media/js/ColVis.min.js"></script>-->
<!--    <script type="text/javascript" src="--><?//= base_url();?><!--Data_table/media/js/fixedHeader.js"></script>-->
<!--    <script type="text/javascript" src="--><?//= base_url();?><!--Data_table/media/js/ZeroClipboard.js"></script>-->
<!--    <script type="text/javascript" src="--><?//= base_url();?><!--Data_table/media/js/fixedColumn.js"></script>-->
<!--    <script type="text/javascript" src="--><?//= base_url();?><!--Data_table/media/js/DataTablesExtensions.js"></script>-->
