    ...
    //                    var CA_cardno ='<tr><td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <input type="checkbox" value='+CA_cardArray[i]+' id='+CA_checkboxid1+' name="checkbox" class="CA_class_cardnumber"   />' + CA_cardArray[i] + '</td><td>                              <select id='+CA_listboxid+' name="CA_selectnamelist" class="CA_class_cardnumber"  visibility: hidden; /></td><td><input type="text" id='+va+' name="CA_selectnamelist1" hidden   /></td></tr>';
        ...
        // FUNCTION TO LOAD CUSTOMER DETAILS'S
            ...
            function CA_load_customerdetails(value_array)
            {
                ...
                if(CA_customerdetails.company!=null){
                ...
                if(CA_guest_array.length!=0)
                {
                    ...
                    for (var i = 0; i < CA_guest_array.length; i++) {
                        CA_value = '<tr ><td style="width:223px"><lable style="width:223px" visibility:hidden; >GUEST '+(i+1)+ ' CARD </lable></td>    <td>    </td><td>   </td>  <td></td><td></td><td></td><td></td><td><input type="text" name="CA_tb_cardno" id='+CA_guest_array[i]+' value='+CA_guest_array[i]+' style="width:50px;"  readonly hidden /></td></tr>';
