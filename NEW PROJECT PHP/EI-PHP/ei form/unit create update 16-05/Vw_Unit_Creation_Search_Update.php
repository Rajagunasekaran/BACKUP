    ...
    /*-------------------------------------------------UNIT SEARCH AND UPDATE FUNCTIONALITY------------------------------------------------*/
        ...
        // CHANGE FUNCTION SEARCH BY ALL TYPES
            $('#USU_lb_searchby').change(function(){
                ...
                $('#USU_subheaderdiv,#USU_carddiv,#USU_roomdiv,#USU_datediv,#USU_stampamtdiv,#USU_paymentamtdiv,#USU_searchbtn,#USU_headermsg,#USU_div_flex,#USU_errmsg_roominventory').hide();
        ...
        // CHANGE EVENT FOR SEARCH BY LISTBOX
            $(document).on('change','.USU_all_searchby',function(){
                $('#USU_cardtype,#USU_cardno,#USU_paymentamtdiv,#USU_stampamtdiv,#USU_div_flex,#USU_headermsg,#USU_errmsg_roominventory').hide();
                $('#USU_form_unitupdate').find('input:text').val('');
        ...
        // CHANGE EVENT FOR SEARCH BY CARD
            $(document).on('change','#USU_lb_typeofcard',function(){
                $('#USU_cardno,#USU_paymentamtdiv,#USU_stampamtdiv,#USU_div_flex,#USU_headermsg,#USU_errmsg_roominventory').hide();
                $('#USU_form_unitupdate').find('input:text').val('');
                    ...
                    if((USU_response_flex.USU_parentfunc_obj!=true && USU_response_flex.USU_parentfunc_obj!=0) || (USU_response_flex.USU_parentfunc_obj=="")){
                        ...
                        if(USU_load_flag_lb==undefined){
                            if(USU_flex_arr!='')
                            {
                                ...
                                {
                                    var USU_sd_msg=USU_errormsg_arr[23].EMC_DATA.replace('[ROOM TYPE]',$('#USU_lb_roomtype').val());
                                }
...
//                                    $('#USU_lbl_msg').text($('#USU_lb_all_searchby').val())
                                ...
                                for(var j=0;j<USU_flex_arr.length;j++)
                                {
                                    if((USU_flex_flag!=7)||((USU_flex_flag==7)&&(j==0))){
                                        if((USU_flex_flag==5) || (USU_flex_flag==8)){
                                            ...
                                            USU_tr +='<tr><td><div class="col-lg-1"><span style="display: block; color:green;" value="'+USU_flex_arr[j][0]+'" class="glyphicon glyphicon-edit USU_class_flex" id="'+(j+1)+'"></div></td>';
                                        }
                                    }
                                    else{
                                        USU_tr +='<tr><td></td>';
                            ...
                            else
                            {
                                ...
                                {
                                    var USU_sd_errmsg=USU_errormsg_arr[32].EMC_DATA.replace('[ROOM TYPE]',$('#USU_lb_roomtype').val());
                                }
                                else if(USU_flex_flag==5)//ROOM TYPE
                                {
