...
class Ctrl_Access_Card_Assign extends CI_Controller{
    ...
    public function Cardassignsave(){
        ...
        $this->load->model('Mdl_access_card_assign');
        $query=$this->Mdl_access_card_assign->Cardassign_save($CA_cust_id,$CA_recver,$CA_comment,$CA_unitno,$CA_fname,$CA_lname,$CA_card_value,$CA_startdate,$CA_enddate,$CA_cardclick,$CA_card_no,$CA_namelist,$USERSTAMP);
        echo json_encode($query);
    }
}