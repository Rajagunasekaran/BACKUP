...
class Mdl_customer_erm_entry_search_update extends CI_Model
{
    public function ERM_EntrySave($UserStamp,$username,$displayname,$Emailtemplate)
    {
        ...
        $dataarray=array($Customername,$Rent,$_POST['ERM_Entry_MovingDate'],$_POST['ERM_Entry_Minimumstay'],$Occupation,($_POST['ERM_Entry_Nationality']=="SELECT")?"":$_POST['ERM_Entry_Nationality'],$_POST['ERM_Entry_Numberofguests'],$_POST['ERM_Entry_Age'],$Contactno,$Mailid,$_POST['ERM_Entry_Comments']);
