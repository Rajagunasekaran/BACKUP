...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click','#CERM_ENTRY_btn_savebutton',function(evt){
            evt.stopPropagation();
            evt.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(value_array.length!=0) {
                        ...
                        var tabledata = '<table style="width:3500px" id="ERM_Datatable" border="1" cellspacing="0"  class="srcresult nowrap"><thead bgcolor="#6495ed" style="color:white"><tr>';
                        tabledata += "<th style='width:80px !important;text-align:center;vertical-align: top'>EDIT/DELETE</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top'>CUSTOMERNAME<span class='labelrequired'><em>*</em></span></th>";
                        tabledata += "<th style='width:150px !important;text-align:center;vertical-align: top''>RENT<span class='labelrequired'><em>*</em></span></th>";
                        tabledata += "<th style='width:150px !important;text-align:center;vertical-align: top' class='uk-date-column'>MOVING DATE<span class='labelrequired'><em>*</em></span></th>";
                        tabledata += "<th style='width:150px !important;text-align:center;vertical-align: top''>MINIMUM STAY<span class='labelrequired'><em>*</em></span></th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>OCCUPATION<span class='labelrequired'><em>*</em></span></th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>NATIONALITY</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>NO OF GUESTS</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>AGE</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>CONTACT NO</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>EMAIL ID</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>COMMENTS<span class='labelrequired'><em>*</em></span></th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top''>USERSTAMP</th>";
                        tabledata += "<th style='width:300px !important;text-align:center;vertical-align: top' class='uk-timestp-column'>TIMESTAMP</th>";
                        ...
                        for (var i = 0; i < value_array.length; i++) {
                            ...
                            tabledata += '<tr id=' + value_array[i].ERM_ID + '>' +
                                "<td style='vertical-align: middle' id=SSICON_"+Ermid+"><div class='col-lg-1'><span style='display: block;color:green' title='Edit' class='glyphicon glyphicon-edit ERM_editbutton' disabled id=" + edit + "></div><div class='col-lg-1'><span style='display: block;color:red' title='Delete' class='glyphicon glyphicon-trash ERM_removebutton' disabled id=" + del + "></div></td>" +
                                "<td class='ERMEdit' style='vertical-align: middle' id=Name_" + Ermid + ">" + value_array[i].ERM_CUST_NAME + "</td>" +
                                "<td style='text-align: middle' id=RENT_" + Ermid + " >" + value_array[i].ERM_RENT + "</td>" +
                                "<td style='text-align: middle' id=MOVINGDATE_" + Ermid + " >" + value_array[i].MOVING_DATE + "</td>" +
                                "<td style='text-align: middle' id=MINSTAY_" + Ermid + " >" + value_array[i].ERM_MIN_STAY + "</td>" +
                                "<td style='vertical-align: middle' id=DATA_" + Ermid + " >" + value_array[i].ERMO_DATA + "</td>" +
                                "<td style='vertical-align: middle' id=NATIONALITY_" + Ermid + " >" + nationality + "</td>" +
                                "<td style='text-align: middle' id=GUEST_" + Ermid + " >" + guest + "</td>" +
                                "<td style='text-align: middle' id=AGE_" + Ermid + " >" + age + "</td>" +
                                "<td style='text-align: middle' id=CONTACT_" + Ermid + " >" + contact + "</td>" +
                                "<td style='vertical-align: middle' id=EMAIL_" + Ermid + " >" + mail + "</td>" +
                                "<td style='vertical-align: middle' id=COMMENTS_" + Ermid + " >" + value_array[i].ERM_COMMENTS + "</td>" +
                                "<td style='vertical-align: middle' id=LOGIN_" + Ermid + " >" + value_array[i].ULD_LOGINID + "</td>" +
                                "<td style='vertical-align: middle' id=TIMESTAMP_" + Ermid + " >" + value_array[i].ERM_TIME_STAMP + "</td></tr>";
                        }
                        tabledata += "</body>";
                        $('section').html(tabledata);
                        $('#ERM_SEARCH_DataTable').show();
                        table = $('#ERM_Datatable').DataTable({
                            "sDom":"Rlfrtip",
                            "deferRender":    true,
                            "scrollY": 200,
                            "scrollX": 500,
            ...
            <div class="panel-body">
                ...
                <div id="ERM_search_update_Form" style="display:none;">
                    <form class="form-horizontal" role="form">
                        ...
                        <div id="ERM_SEARCH_DataTable" hidden>
