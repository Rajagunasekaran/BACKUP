...
//            $('#CCRE_lbl_passporterrormsg').text(errormsg[19].EMC_DATA);
            ...
            error: function (data) {
                show_msgbox("CUSTOMER CREATION", JSON.stringify(data), "error", false);
            }
        });
        //BUTTON VALIDATION
...
//difference between two arrays
        ...
        $(document).on('change', '#CCRE_SDStarttime', function () {
            ...
            if (fromtime != 'Select') {
                var endtimearray=CCRE_startendtimevalues(fromtime);
                var CCRE_options ='';
                for (var i = 0; i < endtimearray.length; i++)
                {
                    CCRE_options += '<option value="' + endtimearray[i] + '">' + endtimearray[i] + '</option>';
                }
                $('#CCRE_SDEndtime').html(CCRE_options);
        ...
        $(document).on('change', '#CCRE_EDStarttime', function () {
            ...
            if (fromtime != 'Select') {
                ...
                $('#CCRE_EDEndtime').html(CCRE_options);
                $('#CCRE_EDEndtime').show();
                $('#endatedateto').show();
            }
            else {
        ...
        function CCRE_startendtimevalues(endtime)
        {
            ...
            else
            {
                ...
                {
                    timearray.push(time_all[j].TIME);
                }
            }
            return timearray;
        }
        ...
        $('#CCRE_btn_savebutton').on('click', function () {
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    {
                        show_msgbox("CUSTOMER CREATION", "RECORD NOT SAVED", "success", false);
                    }
                    else
                    {
            ...
            <form id="CCRE_Form_CustomerCreation" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                <div class="panel-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control passportdatevalidation datenonmandtry ppvalidation" style="max-width:120px;" name="CCRE_PassportDate" id="CCRE_PassportDate"  placeholder="PassportDate">
                        </div>
                        <div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control epdatevalidation datenonmandtry" name="CCRE_EPDate" id="CCRE_EPDate" style="max-width:120px;" placeholder="EP Date">
                        </div>
                        <div>
