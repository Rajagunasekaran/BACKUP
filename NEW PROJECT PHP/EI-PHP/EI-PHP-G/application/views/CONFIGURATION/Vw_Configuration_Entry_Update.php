...
$(document).on('change','#CONFIG_ENTRY_lb_module',function(evnt){
...
$(document).on('change','#CONFIG_ENTRY_lb_type',function(evnt){
    evnt.stopPropagation();
    evnt.preventDefault();
    evnt.stopImmediatePropagation();
    $('.preloader').show();
...
$(document).on('change','#CONFIG_ENTRY_tb_data,#CONF_ENTRY_tb_Datadd',function(evnt){
    evnt.stopPropagation();
    evnt.preventDefault();
    evnt.stopImmediatePropagation();
