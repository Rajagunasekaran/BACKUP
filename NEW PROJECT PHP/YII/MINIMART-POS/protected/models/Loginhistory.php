 ...
 *
 * The followings are the available columns in table 'loginhistories':
 * @property string $id
...
class Loginhistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('login_id, role_id', 'length', 'max'=>10),
			array('login_time, logout_time, created_at,updated_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, login_id, role_id, login_time, logout_time, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
