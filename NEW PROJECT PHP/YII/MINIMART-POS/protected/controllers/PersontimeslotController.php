...
class PersontimeslotController extends Controller
{
/**
...
{
$dataProvider=new CActiveDataProvider('Persontimeslot');
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='persontimeslot-form')
{
